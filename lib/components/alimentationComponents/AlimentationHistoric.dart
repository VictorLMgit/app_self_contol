...
class AlimentationHistoric extends StatefulWidget {
  const AlimentationHistoric({super.key});
      ...
      child: FutureBuilder<List<AlimentationItem>>(
          ...
          builder: (context, snapshot) {
            ...
            switch (snapshot.connectionState) {
              ...
              return Center(child: Column(children: const [CircularProgressIndicator(), Text("Carregando")],),);
                break;
              ...
              case ConnectionState.done:
                  ...
                  if (items.isNotEmpty) {
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) {
                        final AlimentationItem alimentation = items[index];
                        return alimentation;
                      },
                    );
                  }
                  return Center(
                    child: Column(
                      children: const [
                        ...
                        Text("Sem Registro de alimentação!", style: TextStyle(fontSize: 16),)
                      ],
                    ),
                  );
                }
                ...
                break;
              default: return const Text("erro desconhecido");
            }
